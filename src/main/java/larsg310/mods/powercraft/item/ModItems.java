...
//		FluidContainerRegistry.registerFluidContainer(FluidRegistry.getFluidStack(Names.LIQUIDIZED_MATTER, FluidContainerRegistry.BUCKET_VOLUME), new ItemStack(BUCKET_LIQUIDIZED_MATTER), new ItemStack(Items.bucket));
	}
}
